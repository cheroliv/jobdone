...
class CacheConfiguration(
    ...
    fun cacheManagerCustomizer(): JCacheManagerCustomizer {
        return JCacheManagerCustomizer { cm ->
            createCache(cm, toodoo.repository.UserRepository.USERS_BY_LOGIN_CACHE)
            createCache(cm, toodoo.repository.UserRepository.USERS_BY_EMAIL_CACHE)
            createCache(cm, toodoo.domain.User::class.java.name)
            createCache(cm, toodoo.domain.Authority::class.java.name)
            createCache(cm, toodoo.domain.User::class.java.name + ".authorities")
